...
const extractAllItems = document.querySelectorAll("li");
const paginationNumbers = document.querySelector(".pagination-numbers");
// console.log(extractAllItems)
let paginationLimit = 10;
let pageCount = Math.ceil(extractAllItems.length/paginationLimit)
let currentPage = 1;
